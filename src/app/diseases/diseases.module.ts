...
import { MedicationDosageHistoryComponent } from './treatments/medications/medication-dosage-history/medication-dosage-history.component';
...
@NgModule({
  declarations: [
    ...
    MedicationDosageHistoryComponent,
  ],
  imports: [
    MaterialModule,
    CommonModule,
